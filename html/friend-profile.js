...
async function LoadProfileData() {
    ...
    //https://localhost:7204/api/Profile/GetUserProfile?userId=1
 ...
 try {   
        const response = await fetch(`https://localhost:7204/api/Profile/GetUserProfile?${userId}`,{
                method: 'GET',
                headers: {
        ...
        <div class="card-body">
          <div class="d-flex align-items-start">
            ...
            <div class="w-100">
              ...
              <p class="mt-2 mb-0">${post.postText?? 'kdsajjkdsf'}</p>
...
async function GetAllUserFriends() {
 try {
